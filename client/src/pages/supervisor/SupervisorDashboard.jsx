          ...
          {activeTab === 'tasks' && (
            <div className="panel">
              ...
              {placesLoading || cleanersLoading ? (
                ...
                <div className="empty-state">
                  <div className="empty-state-icon">🧹</div>
                  No cleaners registered. Add cleaners first using the <strong>Manage Cleaners</strong> tab.
                </div>
              ) : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {cleaners.map((cleaner) => {
                    // Find all places this cleaner is assigned to (place-level or area-level)
                    ...
                    // Collect all specific area assignments for this cleaner
                          ...
                          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                            ...
                            {totalAreas > 0 && (
                              <span style={{ fontSize: 12, fontWeight: 600, padding: '3px 10px', borderRadius: 8, background: 'rgba(16,185,129,0.12)', border: '1px solid rgba(16,185,129,0.25)', color: '#34d399' }}>
                                🚪 {totalAreas} Specific Area{totalAreas !== 1 ? 's' : ''}
                              </span>
                            )}
                          </div>
                        </div>
